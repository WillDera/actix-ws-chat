...
///
/// Reduce boilerplate of setting up response channels in websocket handlers.
#[derive(Debug, Clone)]
...
impl ChatServerHandle {
    /// Register client message sneder and obtain connection ID.
